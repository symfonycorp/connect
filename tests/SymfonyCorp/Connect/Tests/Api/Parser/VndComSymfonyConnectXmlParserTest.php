...
use SymfonyCorp\Connect\Api\Entity\Project;
use SymfonyCorp\Connect\Api\Entity\Badge;

/**
 * @author Julien Galenski <julien.galenski@sensio.com>
 */
class VndComSymfonyConnectXmlParserTest extends \PHPUnit_Framework_TestCase
{
    private $parser;
    ...
    public function testParseRootAnonymous()
    {
        ...
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Model\Form', $root->getForm('search_projects'));
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Model\Form', $root->getForm('search_users'));
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Model\Form', $root->getForm('search_clubs'));
    }
    ...
    public function getParseIndexTests()
    {
        return array(
            ...
            array('/../../../../../fixtures/clubs.xml', 'create_club', 'POST', 'https://connect.symfony.com/api/clubs', 'SymfonyCorp\Connect\Api\Entity\Club'),
            array('/../../../../../fixtures/projects.xml', 'create_project', 'POST', 'https://connect.symfony.com/api/projects', 'SymfonyCorp\Connect\Api\Entity\Project'),
        );
    }
    ...
    public function testParseFoafPerson()
    {
        ...
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Entity\Index', $memberships);
        $this->assertEquals(3, count($memberships));

        $projects = $user->getProjects();
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Entity\Index', $projects);
    ...
    public function testParseGroup()
    {
        ...
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Entity\Club', $club);
    ...
    public function testParseProject()
    {
        ...
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Entity\Project', $project);
    ...
    public function testParseFormSelect()
    {
        ...
        $this->assertInstanceOf('SymfonyCorp\Connect\Api\Model\Form', $form);
        $options = array(
            'type' => array(
